    ...
    public partial class init_DB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountReviews_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountReviews_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountReviews_AccountId",
                table: "AccountReviews",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountReviews_ProductId",
                table: "AccountReviews",
                column: "ProductId");
